...
if(isset($_POST['submit'])){
    ...
    if(empty($etype)||empty($subject)){
      ...
      if ($image || $file) 
      {
        ...
        $sql1 = "INSERT INTO `mitihani`(`examtype`,`etype`, `subject`, `exam`, `year`) VALUES ('Primary School','$etype','$subject','$name','$year')";
        // echo $sql1; die();
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h4 class="text-dark mb-4">Add Primary Examination to a Bookstore</h4>
                                </div>
                                ...
                                <span>
                                    ...
                                    <div class="mb-3">
                                        <select id="exampleInputPassword" class="form-control form-control-user" type="text" name="subject" />
                                            ...
                                            <option value="Maarifa Ya Jamii">Maarifa Ya Jamii</option>
                                            <option value="Sayansi na Teknologia">Sayansi na Teknologia</option>
                                            <option value="Uraia">Uraia</option>
                                            <option value="Stadi za kazi">Stadi za kazi</option>
                                            <option value="Kifaransa">Kifaransa</option>
                                        </select>
                                    </div>
