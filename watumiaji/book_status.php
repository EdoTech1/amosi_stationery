                    ...
                    <div class="table-responsive mt-2">
                        <table id="myDataTable" class="table">
                            ...
                            <tbody>
                                ...
                                $vuta = "SELECT * FROM book, request, users WHERE book.bid = request.bid AND users.email = request.email AND users.email = '$mtu'";
                                ...
                                while ($me = mysqli_fetch_array($sql)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>$btype</td>";
                                        if($status=='Paid'){
                                            echo "<td><span class='btn bg-info'>$status</span></td>";
                                        }
                                        else{
                                            echo "<td><span class='btn bg-danger'>$status</span></td>";
                                        }
                                    echo "</tr>";
                                    $sno++;
                                }
